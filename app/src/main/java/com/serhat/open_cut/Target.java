...
public class Target {
    ...
    private static String TAG = "Target";
    ...
    public static class Port{
        ...
        public Port(int port, Network.Protocol proto, String service, String version) {
            this.number = port;
            this.protocol = proto;
        ...
        public Port(int port, Network.Protocol proto, String service ) {
            this(port, proto, service, "");
        }

        public Port( int port, Network.Protocol proto ) {
            this( port, proto, "", "" );
        }
        ...
        for(int i = 0; i < ports; i++){
            ...
            Port port = new Port
                    (
                            ...
                            Network.Protocol.fromString(parts[0]),
                            parts[2],
                            parts[3]
                    );
    ...
    public void addOpenPort(int port, Network.Protocol protocol){
        addOpenPort(new Port(port, protocol));
    }

    public void addOpenPort(int port, Network.Protocol protocol, String service){
